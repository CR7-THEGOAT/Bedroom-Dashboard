...
### KISOKE Browser Shell

KISOKE now includes an Electron/Chromium shell under `electron/main.cjs`. It opens the local dashboard without the normal Chrome toolbar or menus.
