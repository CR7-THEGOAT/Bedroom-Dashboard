...
function AssistantPanel({ settings, runCommand, timer, alwaysListening }) {
  ...
  async function enableMicrophoneAndRetry() {
    ...
    if (!nav.mediaDevices?.getUserMedia) {
      setResponse('This browser preview does not expose microphone access. Open Bedroom Dashboard in Chrome or Edge at http://localhost:5173 and allow the microphone.');
  ...
  async function startVoiceInput(mode = 'run') {
    ...
    const SpeechRecognition = speechRecognitionConstructor();
    if (!SpeechRecognition) {
      setResponse('Voice recognition is not supported in this browser preview. Open Bedroom Dashboard in Chrome or Edge, allow microphone access, then retry.');
    ...
    <section className={`tools-page software-page ${mode}`}>
      <header className="dash-top tools-top software-top">
        ...
        <div>
          ...
          <p>Everything to download so Bedroom Dashboard fully works on Ubuntu, Windows testing, local AI, voice, camera, and remote access</p>
        </div>
      ...
      <main className="tools-grid">
        ...
        <section className="panel tool-panel assistant-settings-panel">
          ...
          <div className="ai-settings-grid">
            ...
            <div className="ai-settings-note ai-settings-wide">Put audio inside C:\Users\saeed\OneDrive\Documents\Bedroom Dashboard\music, then use the file name or /media/music/file.mp3.</div>
          </div>
