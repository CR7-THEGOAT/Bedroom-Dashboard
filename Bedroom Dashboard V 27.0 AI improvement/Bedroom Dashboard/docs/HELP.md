...
- rescan the `Bedroom Dashboard/music` folder
...
If browser camera access is unavailable, Bedroom Dashboard falls back to backend camera slots:
...
```text
BEDROOM_DASHBOARD_SKIP_AI_MODELS=true
```
