...
& $Ollama list
Write-Host ""
Write-Host "Done. If Bedroom Dashboard still says models are missing, restart Ollama or restart the laptop so OLLAMA_MODELS is picked up." -ForegroundColor Green
