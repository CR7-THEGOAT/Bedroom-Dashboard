...
export OLLAMA_MODELS="$HOME/Documents/KISOKE/ollama"
...
On Windows, this project is using `C:\Users\saeed\OneDrive\Documents\KISOKE\ollama` as the Ollama model folder.

Windows PowerShell model-folder setup:

```powershell
[Environment]::SetEnvironmentVariable('OLLAMA_MODELS', 'C:\Users\saeed\OneDrive\Documents\KISOKE\ollama', 'User')
$env:OLLAMA_MODELS='C:\Users\saeed\OneDrive\Documents\KISOKE\ollama'
ollama pull llama3.2:1b
ollama pull qwen2.5:3b
ollama pull qwen3:4b
```
...
- Browser speech recognition when the browser supports it. Tap the mic once to arm Chrome permission; after that always-listening runs while the KISOKE tab is open and awake.
